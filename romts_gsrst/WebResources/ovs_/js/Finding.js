...
(function (ROM) {
    ...
    (function (Finding) {
        ...
        function onLoad(eContext) {
            ...
            Xrm.WebApi.retrieveRecord("businessunit", currentUserBusinessUnitFetchXML).then(function (businessunit) {
                var userBusinessUnitName = businessunit.name;
                ...
                if (operationTypeAttributeValue != null) {
                    ...
                    Xrm.WebApi.retrieveRecord("businessunit", operationTypeOwningBusinessUnitFetchXML).then(function (result) {
                        var operationTypeOwningBusinessUnit = result.name;
