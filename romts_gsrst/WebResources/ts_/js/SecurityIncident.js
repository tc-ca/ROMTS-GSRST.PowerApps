    ...
    (function (SecurityIncident) {
        ...
        function modeOnChange(eContext) {
            ...
            if (mode.getValue() == 717750001 /* IBT */) {
                ...
                //Set custom view for Site
                var viewIBTLocationId = '{73e123a5-2d58-4642-a298-6d7e4edc089e}';
                ...
                // form.getControl("ts_ibtlocation").setVisible(false); 57f1ece8-04ac-4178-b2bd-cbd292d2ecc4
