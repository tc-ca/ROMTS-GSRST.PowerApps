...
(function (ROM) {
    ...
    (function (Operation) {
        ...
        function onLoad(eContext) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    ...
                    setRelatedActionsFetchXML(eContext);
                    return [2 /*return*/];
                });
            });
        }
        ...
        function setRelatedActionsFetchXML(eContext) {
            var form = eContext.getFormContext();
            ...
            if (gridControl === null) {
                ...
                var fetchXml = "<fetch version=\"1.0\" mapping=\"logical\" distinct=\"true\" count=\"50\"><entity name=\"ts_action\"><attribute name=\"ts_name\"/><attribute name=\"createdon\"/><attribute name=\"ts_actiontype\"/><attribute name=\"ts_actionstatus\"/><attribute name=\"ts_actioncategory\"/><attribute name=\"ownerid\"/><attribute name=\"ts_actionid\"/><order attribute=\"ts_finding\"/><order attribute=\"ts_name\"/><link-entity name=\"ts_actionfinding\" from=\"ts_action\" to=\"ts_actionid\" link-type=\"inner\" alias=\"af\"><link-entity name=\"ovs_finding\" from=\"ovs_findingid\" to=\"ts_ovs_finding\" link-type=\"inner\" alias=\"f\"><link-entity name=\"ovs_operation\" from=\"ovs_operationid\" to=\"ts_operationid\" link-type=\"inner\" alias=\"op\"><attribute name=\"ovs_operationid\"/><filter><condition attribute=\"ovs_operationid\" operator=\"eq\" value=\"".concat(operationId, "\"/></filter></link-entity></link-entity></link-entity></entity></fetch>");
